...
Many thanks to[Andy Hayden](https://github.com/hayd/deno-lambda) for creating
the basis for this work.

_Deploy deno code via
[SAR application](https://serverlessrepo.aws.amazon.com/applications/arn:aws:serverlessrepo:us-east-1:702899346695:applications~deno)
(see
[quick start](https://github.com/ehsankhfr/deno-lambda/blob/main/QUICK-START.md)),
[SAM](https://github.com/ehsankhfr/deno-lambda/tree/main/example-sam),
[serverless](https://github.com/ehsankhfr/deno-lambda/tree/main/example-serverless),
...
- :bowtie:
  ...
  (see
  [quick start](https://github.com/ehsankhfr/deno-lambda/blob/main/QUICK-START.md))
- [SAM example](https://github.com/ehsankhfr/deno-lambda/tree/main/example-sam)
- [Serverless example](https://github.com/ehsankhfr/deno-lambda/tree/main/example-serverless)
  (feat. [Dynamodb](https://github.com/chiefbiiko/dynamodb/))
- [AWS CDK example](https://github.com/ehsankhfr/deno-lambda/tree/main/example-aws-cdk)
- [Docker container example](https://github.com/ehsankhfr/deno-lambda/tree/main/example-docker-container)
...
_See
[earlier version of quick start](https://github.com/ehsankhfr/deno-lambda/blob/main/QUICK-START-OLD.md)
...
See
[`example-serverless/serverless.yml`](https://github.com/ehsankhfr/deno-lambda/blob/main/example-serverless/serverless.yml).
